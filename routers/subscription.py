...
@subscription_router.get("/subscriptions/me", response_model=List[SubscriptionResp])
...
@subscription_router.get("/my/subscribers", response_model=List[MySubscriptionResp])
async def obuna_bolganlarni_korish(
    ...
    if not channel:
        raise HTTPException(404, "Sizda hali kanal mavjud emas.")
